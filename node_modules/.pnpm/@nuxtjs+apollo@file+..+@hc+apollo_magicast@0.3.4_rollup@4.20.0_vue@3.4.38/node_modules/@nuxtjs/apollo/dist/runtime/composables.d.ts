...
export declare function useAsyncMutation<T>(opts: TAsyncQuery<T>): AsyncData<T, Error>;
export declare function useAsyncMutation<T>(query: TQuery<T>, clientId?: string): AsyncData<T, Error>;
export declare function useAsyncMutation<T>(query: TQuery<T>, variables?: TVariables<T>, clientId?: string): AsyncData<T, Error>;
